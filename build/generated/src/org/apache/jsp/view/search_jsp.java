...
public final class search_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 break;
      ...
      out.write("                    <h4 class=\"card-title \">Search</h4>\n");
      out.write("                    <p class=\"card-category\"> Search By These </p>\n");
      out.write("                </div>\n");
 ...
 for (Map.Entry<Integer, String> cl : modle.GetInstans.getMailCatagory().getCatagoryList().entrySet()) {
      ...
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      out.write("                            <button type=\"submit\" id=\"\" class=\"btn btn-primary pull-right\">Search</button>         \n");
      out.write("                        </form>                        \n");
      out.write("\n");
      out.write("                    </div>\n");
      out.write("                    <br><br><hr>\n");
      ...
      out.write("                                ");
                                    ...
                                    if (request.getSession().getAttribute("milist") != null) {
                                        ...
                                        ArrayList<Integer> ar = (ArrayList) request.getSession().getAttribute("milist");
                                        for (Integer elem : ar) {
