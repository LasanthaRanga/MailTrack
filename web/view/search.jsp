        ...
        <div class="col-md-12" >
            <div class="card">
                <div class="card-header card-header-primary">
                    ...
                    <p class="card-category"> Search By These </p>
                </div>
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <form method="POST" action="../Search">
                            ...
                            <button type="submit" id="" class="btn btn-primary pull-right">Search</button>         
                        </form>                        
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> 2018.10.10</td>
                                    <td> Water</td>
                                    <td><a href="../view/edit.jsp" class="btn btn-info btn-sm"> Edit </a></td>
                                </tr>
